...
| Name | Type |
|------|------|
| [github_issue_labels.repo_label](https://registry.terraform.io/providers/integrations/github/6.4.0/docs/resources/issue_labels) | resource |
| [github_repository.repo](https://registry.terraform.io/providers/integrations/github/6.4.0/docs/resources/repository) | resource |
| [github_repository_collaborators.repo_collaborators](https://registry.terraform.io/providers/integrations/github/6.4.0/docs/resources/repository_collaborators) | resource |
...
| <a name="input_github_repository_file_branch"></a> [github\_repository\_file\_branch](#input\_github\_repository\_file\_branch) | Branch to create the file in | `string` | `"terraform_factory"` | no |
| <a name="input_github_repository_file_commit_author"></a> [github\_repository\_file\_commit\_author](#input\_github\_repository\_file\_commit\_author) | Author to use when creating files | `string` | `null` | no |
| <a name="input_github_repository_file_commit_email"></a> [github\_repository\_file\_commit\_email](#input\_github\_repository\_file\_commit\_email) | Email to use when creating files | `string` | `null` | no |
| <a name="input_github_repository_file_commit_message"></a> [github\_repository\_file\_commit\_message](#input\_github\_repository\_file\_commit\_message) | Commit message to use when creating files | `string` | `"Managed by OpenTofu"` | no |
| <a name="input_github_repository_file_files_and_content"></a> [github\_repository\_file\_files\_and\_content](#input\_github\_repository\_file\_files\_and\_content) | Files to create | <pre>list(object({<br>    file          = string<br>    content       = optional(string)<br>    file_location = optional(string)<br>  }))</pre> | `[]` | no |
| <a name="input_github_repository_file_overwrite_on_create"></a> [github\_repository\_file\_overwrite\_on\_create](#input\_github\_repository\_file\_overwrite\_on\_create) | Overwrite the file if it already exists | `bool` | `false` | no |
| <a name="input_github_repository_file_source_branch"></a> [github\_repository\_file\_source\_branch](#input\_github\_repository\_file\_source\_branch) | Branch to copy the file from | `string` | `"main"` | no |
| <a name="input_github_repository_file_source_sha"></a> [github\_repository\_file\_source\_sha](#input\_github\_repository\_file\_source\_sha) | SHA of the source branch | `string` | `null` | no |
| <a name="input_github_token"></a> [github\_token](#input\_github\_token) | Authentication token used for github. | `string` | `""` | no |
